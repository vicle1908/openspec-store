...
- [ ] Verify @xenova/transformers is installed (should be v2.17.2 in agentmemory node_modules)
- [ ] Pull Ofable-5 `fable-5.2:3b` model (~2GB) for LLM compression
...
- [ ] Verify all-MiniLM-L6-v2 model downloaded to ~/.cache/xenova/
...
- Ollama (PID 88072/88084): RUNNING — no models loaded

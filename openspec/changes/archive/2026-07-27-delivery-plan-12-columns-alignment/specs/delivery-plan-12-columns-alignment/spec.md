# Capability: delivery-plan-12-columns-alignment

## Purpose

Align the Delivery Plan Analysis tab to exactly 12 columns, removing extra columns that create visual clutter.

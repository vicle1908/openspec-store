...
Migrate PostgreSQL from 17-alpine to 18.4-alpine with fresh start (no data migration).

## ADDED Requirements

### Requirement: PGM-001: Fresh Start

The system SHALL delete all old data and start fresh with PostgreSQL 18.4.
...
And it shall start PostgreSQL 18.4 container
And it shall initialize fresh database

### Requirement: PGM-002: Service Verification

The system SHALL verify all services can connect to PostgreSQL 18.4 after fresh start.
...
#### Scenario: Rollback
Given PostgreSQL 18.4 fresh start failed

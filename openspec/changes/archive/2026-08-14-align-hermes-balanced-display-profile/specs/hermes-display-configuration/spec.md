# Spec delta for hermes-display-configuration

This delta is applied to
`openspec/specs/hermes-display-configuration/spec.md`
when the `align-hermes-balanced-display-profile` change is archived.

...
Define the architectural boundaries that confine pydantic-ai v2.9 to a replaceable internal layer, ensuring no vendor lock-in and enabling future engine swaps without consumer impact.

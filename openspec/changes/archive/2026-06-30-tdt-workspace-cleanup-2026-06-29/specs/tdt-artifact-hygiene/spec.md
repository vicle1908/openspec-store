# Capability: tdt-artifact-hygiene

## Purpose

Define the contract for keeping auto-generated tooling output (GitNexus/Graphify caches, lockfile backups) out of source control and out of cross-repo working trees, so future regenerations cannot re-pollute tracked files.

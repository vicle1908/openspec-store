...
- [x] [historical] 1.3 Add unit tests for `classify_platform` covering iOS, Android, QA, unclassified, and mixed tags
...
- [x] [historical] 2.4 Add unit tests for platform column population
...
- [x] [historical] 3.4 Add unit tests for progress computation
...
> **Historical record:** This change was archived with 3 incomplete task(s) (13/16 completed). The remaining tasks were not implemented or were superseded by subsequent changes.

# Capability: dev-performance-sprint-scoping

## Purpose

Make dev-performance report default to sprint period for consistent scoping with sprint-sheet and person-capacity reports, while allowing override via CLI flag, env var, or config.toml.

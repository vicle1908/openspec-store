...
Define which ECC rule directories surface in our installation. ECC's `rules/<lang>/` are language-specific coding standards auto-loaded when the working directory matches that language.

...
- [x] 8.1 `openspec validate fix-app-services-apply-schedules` exits 0 → **passed 2026-07-01**
- [x] 8.2 `openspec archive fix-app-services-apply-schedules --yes` archives → **archived 2026-07-01, commit 2441be20**

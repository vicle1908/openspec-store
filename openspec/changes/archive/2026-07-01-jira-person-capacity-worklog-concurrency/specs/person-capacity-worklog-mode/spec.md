...
**Status:** Modified
**Date:** 2026-06-15
**Version:** 1.4 (concurrency delta — v1.3 displayed-name keying + trailing-empty fix still active)

This is a **delta** to the v1.3 spec. It adds a `Concurrency` requirement and clarifies the existing `JQL is chunked at 150 display names` requirement to scope "sequential" to *chunks*, not per-issue worklog fetches within a chunk. No existing requirement is removed.

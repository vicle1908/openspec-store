...
Define which ECC commands surface in our installation. Distinguish trigger-point commands (entry points to skills/agents) from passive helpers, and route trigger-point commands to the appropriate TDT workflow where applicable.

...
- [x] **8.1** `/opsx:archive` the change. ~5 min
  - Archived as `archive/2026-06-27-ecc-harness-alignment`
  - All 7 specs merged into `openspec/specs/` (+38 requirements)
- [x] **8.2** Add a "How to run the next audit" note to the change's archived body. ~10 min
  - Added at end of `archive/2026-06-27-ecc-harness-alignment/proposal.md`

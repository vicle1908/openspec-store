...
## Purpose
Defines the shared allowlisted credential loader for zsh-based coding agents. The loader reads only HERMES_CUSTOM_*_API_KEY from the canonical ~/.hermes/.env and is wired through .zshenv. Unrelated Hermes variables are not exported.
## Requirements

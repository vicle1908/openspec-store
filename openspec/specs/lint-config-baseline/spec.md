# lint-config-baseline Specification

## Purpose
Enforces a canonical ruff rule set and strict mypy configuration across all Python repos, with a validator script and inline fix requirements for newly surfaced violations.
## Requirements

...
Provides agents with on-demand access to Pydantic AI documentation via the PyaiDocs capability, enabling the agent to read documentation topics at runtime.

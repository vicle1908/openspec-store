# agent-device-command-surface Specification

## Purpose
Documents the `agent-device` CLI command surface: navigation, interaction, inspection, evidence capture, and platform-specific commands for mobile and desktop automation.

# scheduler-timezone-clarification Specification

## Purpose
Documents the scheduler timezone model: DBOS `cron_timezone` per-decorator independence from the container `TZ` env var, with inline comments and README guidance.
## Requirements

# Workstation Storage Hygiene Specification

## Purpose

Define a measured, safety-gated macOS workstation storage-cleanup workflow
that protects active and stateful resources, records verifiable recovery, and
hands off separately to repository readiness checks.

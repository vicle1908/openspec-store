# maccy-workstation-clipboard-management Specification

## Purpose

Define a secure, single-recorder Maccy installation, configuration, acceptance, evidence, and recovery standard for the designated macOS workstation.

...
- **THEN** the engine SHALL raise `SchedulerContractViolationError` whose message names the offending `app_name` and the canonical owner, and SHALL NOT register any schedules

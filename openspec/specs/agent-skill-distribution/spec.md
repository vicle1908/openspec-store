...
Define canonical, reproducible, multi-agent project skill surfaces and safe
synchronization, repair, compatibility, verification, and rollback behavior
across the outer and nested Git roots.

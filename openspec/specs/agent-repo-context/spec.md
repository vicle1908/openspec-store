...
Provides agents with repository context by auto-loading AGENTS.md/CLAUDE.md files as system instructions, with optional inventory tool for discovering available context files.
